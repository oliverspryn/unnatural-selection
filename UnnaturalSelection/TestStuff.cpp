...
// Test gun Gun(0, 16*60*60, 100, 2000, 1000, 100, 10, 0.3, 0, ONE);
	...
	gunz[1] = new Gun(3, 10*60, 500, 2000, 1000, 0, 15, 0.01, 0, ONE);
	gunz[2] = new Gun(5, 15*60, 500, 2000, 1000, 0, 10, 0.01, 1, ONE);
	gunz[3] = new Gun(2, 6*60*60, 500, 2000, 1000, 0, 20, 0.5, 6, ONE);
